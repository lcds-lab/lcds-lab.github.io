...
title: "多层数据倾向得分分析"
date: 2026-08-01
description: "系统综述多层教育数据中的倾向得分分析，并为研究者提供实用方法指南。"
...
- 系统综述 2005 至 2025 年间使用多层数据倾向得分分析的教育研究。
- 梳理数据准备、倾向得分估计、方法实施、协变量平衡评估、处理效应估计和敏感性分析六个环节中的方法选择。
- 将常见应用实践与方法学文献中的建议进行比较。
- 为嵌套教育数据中的倾向得分分析提供方法选择、实施和报告指南。
- 通过博士生用户测试改进项目成果的可理解性和实用性。

## 计划成果

- 一篇系统综述论文。
- 在学术会议上开设多层数据倾向得分分析培训课程。
- 分析流程图和报告清单。
- 项目网站和 YouTube 视频系列。

## 链接

- [IES 官方项目页面](https://ies.ed.gov/use-work/awards/propensity-score-analysis-multilevel-data-systematic-review)

## 相关项目

- [基于倾向得分的准实验研究规划](/zh/projects/hdose-propensity-score-power/)
